...
var ACTIVITY_VALID_EVENT_TYPES_ = {
  ...
  expenses_refresh: true,
  expenses_filter_change: true,
  expenses_risk_month: true,
  expenses_drawer_open: true,
  expenses_export_csv: true,
  expenses_sort: true,
  ...
  delivery_pnl_view_toggle: true,
  delivery_pnl_performance_tab: true,
  delivery_pnl_hours_toggle: true,
  delivery_pnl_perf_date_range: true,
  delivery_pnl_timing_badge_click: true,
  delivery_pnl_copy_csv: true,
  delivery_pnl_perf_copy_csv: true,
  delivery_pnl_perf_time_drill: true,
  ...
  services_summary_refresh: true,
  services_summary_filter: true,
  services_summary_sort: true,
  services_summary_search: true,
  ...
  portfolio_pnl_export_excel: true,
  data_source_change: true,
  snapshot_bundle_load_start: true,
  snapshot_bundle_load_done: true,
  snapshot_bundle_load_error: true,
  settings_panel_open: true,
  admin_settings_save: true,
  admin_settings_save_error: true,
  profile_open: true,
  profile_save: true,
  ...
  ai_usage_refresh: true,
  ai_usage_filter_change: true,
  ...
  resource_assignments_cell_drilldown: true,
  resource_assignments_coverage_filter: true,
  resource_assignments_coverage_drill: true,
  ...
  lookback_nav: true,
  lookback_month_open: true,
  lookback_project_open: true,
  lookback_opt_in: true,
