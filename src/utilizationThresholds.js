 ...
 *   - Section U.9 Weekly capacity baseline.
 *   - Section U.10 Utilization color buckets.
 *   - Section U.11 Internal-company detection rules.
 *   - Date-range defaults / caps.
 *   - Top-N caps for the Section N.4 / Section N.5 / Section N.7 horizontal bars.
 *
 ...
 *
 * The agreement-dashboard module already defines the Section 8.5 customer palette
...
var UTILIZATION_DASHBOARD_CACHE_SCHEMA_VERSION_ = 3;
...
/** @const {!Object} Section U.10 utilization buckets - same hues as the spec. */
...
/**
 * Section U.11 "is this row internal labor?" predicate. Returns true when:
