...
| **ADMIN-only route (v3.8.1)** | Operations **Agreements** nav and `getAgreementDashboardData` are **Role ADMIN** only. Non-ADMIN users keep Revenue review / Delivery / Services Summary via other APIs. Teamwork: [v3.8.1 - Agreements route ADMIN-only](https://win.godeap.io/app/tasks/40848298). | **Delivered v3.8.1** |
