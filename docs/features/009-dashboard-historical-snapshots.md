...
| `delivery-pnl/*.json` | `buildDeliveryProjectMonthlyPnLInternal_` | Batched; continuation trigger if needed; `cacheSchemaVersion: 7` (v2.12.8: `allocatedByRole`; was **6** through v2.12.7 for chart `resourceAllocations`) |
