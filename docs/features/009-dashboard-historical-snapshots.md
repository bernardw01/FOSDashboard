...
| `delivery-pnl/*.json` | `buildDeliveryProjectMonthlyPnLInternal_` | Batched; continuation trigger if needed; `cacheSchemaVersion: 8` (v2.13.0: `laborEmployee` / `laborContractor`; was **7** through v2.12.9) |
