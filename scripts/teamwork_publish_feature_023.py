#!/usr/bin/env python3
"""Publish Feature 023 notebook + release task (Spec Draft) from docs/features/023-*.md."""
...
NOTEBOOK_KEY = "feature_023"
NOTEBOOK_TITLE = "Feature 023 - AI Usage dashboard"
NOTEBOOK_DESC = (
    "Finance AI Usage panel: developer vs product spend (AI Usage Tracker), "
    "unmatched bucket, monthly trend, Utilization-style date/person/role filters. "
    "Intake from Inbox task 40180160."
)
FEATURE_MD = ROOT / "docs/features/023-ai-usage-dashboard.md"
MANIFEST = ROOT / "docs/teamwork-manifest.json"
INBOX_TASK_ID = 40180160
TASKLIST_NAME = "Finance"
RELEASE_TASK_NAME = "Feature 023 - AI Usage dashboard"
...
def main() -> None:
    ...
    if task_key not in manifest.get("tasks", {}):
        ...
        desc = (
            ...
            "Intake: Inbox task 40180160 - AI Usage Dashboard\n\n"
            "Scope: Finance nav AI Usage (after Expenses); read Fibery AI Usage Data/Usage; "
            "developer bar chart (people), product bar chart (Clockify Users with AI Usage Tracker), "
            "unmatched bucket, monthly trend; date range + Person + Role filters and Refresh "
            "matching Utilization Management Dashboard UX.\n\n"
            f"Notebook: {nb_url}\n"
            f"Git spec: docs/features/023-ai-usage-dashboard.md\n"
            f"Inbox: {task_url(INBOX_TASK_ID)}\n"
        ...
        manifest.setdefault("tasks", {})[task_key] = {
            ...
            "releaseTitle": "AI Usage dashboard",
            "provisionalTaskName": True,
            "shippedVersion": None,
            "notebookKey": NOTEBOOK_KEY,
            "intakeTaskId": INBOX_TASK_ID,
            "url": release_task_url,
            "renameAtShip": "v{FOS_PRD_VERSION} - AI Usage dashboard",
